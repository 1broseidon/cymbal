 ...
 * folded into the manual lands on its anchor; what stayed in the repo points at
 * the file on GitHub. Unmapped paths 404 honestly rather than bouncing to a
 * homepage that doesn't answer the question. */
const REPO = 'https://github.com/1broseidon/cymbal/blob/main'
const redirects = `# Generated by build.mjs — do not edit.
/reference/commands        ${REPO}/docs/reference/commands.md   301
/guide/library             ${REPO}/docs/guide/library.md        301
/guide/agent-native        /#for-agents                         301
/guide/getting-started     /#quickstart                         301
/AGENT_HOOKS               ${REPO}/HOOKS.md                     301
/changelog                 ${REPO}/CHANGELOG.md                 301
